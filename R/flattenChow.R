...
#' @return Returns a data.frame, sorted by superNOVA p-value, where each row is a feature pair, with columns "GeneA","GeneB","groupCor","groupCorPval","globalCor","globalCorP","pValDiff","Classes".
#' @keywords superNOVA
#' @export
flattenChow = function(chow_result){
  ...
  columns = c("GeneA","GeneB","groupCor","groupCorPval","globalCor","globalCorP","pValDiff","Classes")
